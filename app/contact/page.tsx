  ...
  return (
    <main className="pt-20">
      ...
      <section className="bg-gradient-to-br from-primary to-primary/80 text-primary-foreground py-20 relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-primary-foreground/90 max-w-3xl mx-auto">
            We're here to listen, support, and guide you on your mental wellness journey
          </p>
        </div>
      </section>
            ...
            {[
              {
                icon: MapPin,
                title: "Visit Us",
                details: ["Life Changers Care & LIFT Initiative", "Mental Wellness Center", "Lagos, Nigeria"],
              },
              {
                icon: Phone,
                title: "Call Us",
                details: ["+234 (0) XXX XXXX XXX", "Available Mon-Fri: 9AM-6PM", "Emergency Support: 24/7"],
              },
              {
                icon: Mail,
                title: "Email Us",
                details: ["hello@lifechangers.ng", "support@lifechangers.ng", "careers@lifechangers.ng"],
              },
            ].map((contact, i) => (
              <div
                key={i}
              ...
              >
                ...
                <h3 className="text-xl font-bold text-primary mb-4">{contact.title}</h3>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  <label htmlFor="serviceInterest" className="block text-sm font-semibold text-foreground mb-2">
                    Service of Interest
                  </label>
                  <select
                    id="serviceInterest"
              ...
              <div className="bg-card p-8 rounded-xl border border-border">
                ...
                <ul className="space-y-4 text-foreground/80">
                  <li className="flex gap-3 items-start">
                    <span className="text-accent font-bold text-xl flex-shrink-0">1</span>
                    <span>
                      <strong>Initial Contact:</strong> We'll respond within 24 hours to acknowledge your message
                    </span>
                  </li>
                  <li className="flex gap-3 items-start">
                    <span className="text-accent font-bold text-xl flex-shrink-0">2</span>
                    <span>
                      <strong>Consultation:</strong> We'll discuss your needs and find the best service for you
                    </span>
                  </li>
                  <li className="flex gap-3 items-start">
                    <span className="text-accent font-bold text-xl flex-shrink-0">3</span>
                    <span>
                      <strong>Scheduling:</strong> We'll work with you to find convenient appointment times
                    </span>
                  </li>
                  <li className="flex gap-3 items-start">
                    <span className="text-accent font-bold text-xl flex-shrink-0">4</span>
                    <span>
                      <strong>Confidentiality:</strong> Your privacy is protected under professional standards
                    </span>
                  </li>
                </ul>
              </div>
                ...
                <div className="flex gap-4 items-start mb-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-primary-foreground/90 mb-4">
                      If you're experiencing a mental health crisis or emergency, please contact emergency services or
                      reach out to our 24/7 crisis line immediately.
                    </p>
                    <p className="font-bold text-accent">Crisis Hotline: +234 XXXX XXXX</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="space-y-4">
            {[
              ...
              >
                ...
                <div className="px-6 pb-6 text-foreground/80 border-t border-border">{faq.answer}</div>
              </details>
            ))}
          </div>
        </div>
      ...
      <section className="py-16 bg-primary text-primary-foreground text-center">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold mb-4">Join Thousands Who've Started Their Healing Journey</h2>
          <p className="text-lg text-primary-foreground/90 mb-8">
            Your first step towards mental wellness is just a message away
          </p>
          <button
            onClick={() => document.querySelector("#firstName")?.scrollIntoView({ behavior: "smooth" })}
